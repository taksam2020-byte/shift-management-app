  ...
  return (
    <div className="container mx-auto p-4 max-w-2xl">
      ...
      <div className="bg-white rounded-lg shadow-md">
        <h2 className="text-xl font-semibold p-4 border-b">設定済み休業日一覧 <span title="土日祝以外の会社の休日を設定します。ここで設定した日はシフト作成画面で全員が自動的に「休み」になります。" className="text-gray-400 cursor-help font-normal text-sm">ⓘ</span></h2>
